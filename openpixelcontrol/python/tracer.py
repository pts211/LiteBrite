...
def pixel_color(t, coord, ii, n_pixels):
    ...
    x, y, z = coord
    r = 0 #color_utils.cos(x, offset=t / 4, period=1, minn=0, maxx=0.7)
    g = 0#color_utils.cos(y, offset=t / 4, period=1, minn=0, maxx=0.7)
    b = 0#color_utils.cos(z, offset=t / 4, period=1, minn=0, maxx=0.7)
